      ...
      def self.setup_guide
        {
          ...
          steps: [
            ...
            { title: "Enable OAuth Settings", description: "Check 'Enable OAuth Settings'. Set the Callback URL to your Vault OAuth callback: http://localhost:4006/oauth/callback/salesforce (or your production URL). Select OAuth scopes: 'Full access (full)' and 'Perform requests at any time (refresh_token, offline_access)'." },
          ...
          tips: [
            ...
            "The callback URL in Salesforce must match exactly: http://localhost:4006/oauth/callback/salesforce"
          ],
          credential_help: {
